...
int main(int argc, char** argv)
{
    ...
    //Estado Inicial del algoritmo del banero
    ...
    if (myfile.is_open()) {
        ...
        cout << "ingrese el Numero de Procesos P:";
        cin >> n;
        cout << "ingrese el Numero de Recursos R:";
        cin >> m;
        //imprimir el tamanio seleccionado
        cout << "Proporcion de la matriz a procesar: " << n << " X " << m << endl;
